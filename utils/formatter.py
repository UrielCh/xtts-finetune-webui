...
def format_audio_list(
    ...
    for audio_path in tqdm_object:
        ...
        # If we found that we've already processed this file before, continue
        # to next iteration.
        if skip_processing:
            continue
        ...
        for word_idx, word in enumerate(words_list):
            if first_word:
                ...
                # If it is the first sentence, add buffer or get the begining
                # of the file
                if word_idx == 0:
            ...
            if word.word[-1] in ["!", "。", ".", "?"]:
                ...
                if word_idx + 1 < len(words_list):
                    ...
                    # If don't have more words it means that it is the last
                    # sentence then use the audio len as next word start
