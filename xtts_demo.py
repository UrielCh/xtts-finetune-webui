    ...
    with gr.Blocks() as demo:
        ...
        with gr.Tab("2 - Fine-tuning XTTS Encoder"):
            ...
            def train_model(
                ...
                # Check if the dataset language matches the language you
                # specified
                lang_file_path = Path(output_path) / "dataset" / "lang.txt"

                # Check if lang.txt already exists and contains a different
                # language
            ...
            def optimize_model(out_path, clear_train_data):
                ...
                return (
                    f"Model optimized and saved at {ft_xtts_checkpoint}!",
                    ft_xtts_checkpoint,
                )
